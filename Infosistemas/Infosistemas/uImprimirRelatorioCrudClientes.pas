unit uImprimirRelatorioCrudClientes;
...
const
  AlturaPadraoBandaDetalheQuandoOcuparApenasUmaLinhaDeAltura            = 21;

type
  TfrmImprimirRelatorioCrudClientes = class(TForm)
...
var
  frmImprimirRelatorioCrudClientes: TfrmImprimirRelatorioCrudClientes;
...
procedure TfrmImprimirRelatorioCrudClientes.qrbDetalheAfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  if BandPrinted then
  begin
...
procedure TfrmImprimirRelatorioCrudClientes.qrpRelatorioBeforePrint(
...
procedure TfrmImprimirRelatorioCrudClientes.qrpRelatorioEndPage(
  Sender: TCustomQuickRep);
begin
  qrbDetalhe.Color := clWhite;
end;

procedure TfrmImprimirRelatorioCrudClientes.PrepararRelatorio(
  FormDialogoCrudClientes: TfrmDialogoCrudClientes;
  TituloRelatorio: String );
const
...
procedure TfrmImprimirRelatorioCrudClientes.qrsDataHoraPrint(
...
procedure TfrmImprimirRelatorioCrudClientes.qrsPaginaPrint(
  sender: TObject; var Value: String);
begin
  Value := Value + ' de ' + IntToStr( frmImprimirPrevisaoImpressao.QuantidadeTotalDePaginas );
end;

procedure TfrmImprimirRelatorioCrudClientes.AbrirTabela(
  ClausulaSQL: String );
begin
...
procedure TfrmImprimirRelatorioCrudClientes.qrbTituloBeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  qriLogotipo.Left := Round( ( qrbTitulo.Width - qriLogotipo.Width ) / 2 );
end;

procedure TfrmImprimirRelatorioCrudClientes.qrpRelatorioPreview(
  Sender: TObject);
begin
  frmImprimirPrevisaoImpressao.qrpPrevisao.QRPrinter :=
    frmImprimirRelatorioCrudClientes.qrpRelatorio.QRPrinter;
  frmImprimirPrevisaoImpressao.Show;
end;

procedure TfrmImprimirRelatorioCrudClientes.qrbCabecalhoBeforePrint(
  Sender: TQRCustomBand; var PrintBand: Boolean);
begin
  PrintBand := EmCadaPaginaMostrarBandaCabecalhoComNomeColunas;
end;

procedure TfrmImprimirRelatorioCrudClientes.qrdNomePrint(
  sender: TObject; var Value: String);
begin
